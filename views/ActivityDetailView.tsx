...
const ActivityDetailView: React.FC<ActivityDetailViewProps> = ({ activity, onBack }) => {
  return (
    <div className="pt-20 bg-navy-950 min-h-screen animate-fadeIn relative">
        ...
        <div className="h-[30vh] md:h-[40vh] relative">
            ...
            <div className="absolute bottom-0 left-0 w-full p-4 md:p-12">
                <div className="container mx-auto">
                    <button 
                        onClick={onBack} 
                        className="flex items-center text-slate-300 hover:text-white mb-4 md:mb-6 transition-colors text-sm bg-black/20 px-3 py-1 rounded-full w-fit backdrop-blur-sm"
                    >
