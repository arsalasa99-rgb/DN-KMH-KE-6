...
const MobileItemCard = ({ no, name, unit, price, total, isHeader = false }: any) => (
  <div className="bg-white/5 backdrop-blur-sm p-4 rounded-xl border border-white/10 shadow-sm flex flex-col gap-2 mb-3">
    <div className="flex justify-between items-start">
      <div className="flex gap-3">
         {no && <span className="flex-shrink-0 w-6 h-6 bg-sky-500/20 text-sky-300 rounded-full flex items-center justify-center text-xs font-bold border border-sky-500/30">{no}</span>}
         <div>
            <h5 className="font-bold text-white text-sm">{name}</h5>
            {!isHeader && <p className="text-xs text-slate-400 mt-0.5">{unit} x Rp{price}</p>}
         </div>
      </div>
    </div>
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="text-center mb-12 reveal">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/10 text-white rounded-full text-xs font-bold uppercase tracking-widest mb-4 border border-white/20 backdrop-blur-md">
                <Calculator size={14} className="text-sky-400" /> Transparansi Anggaran
            </div>
        ...
        <div className="space-y-8 md:space-y-12 max-w-5xl mx-auto">
            ...
            {/* 1. SEMINAR HUKUM */}
            <div className="bg-navy-900/50 backdrop-blur-md rounded-2xl shadow-xl border border-white/10 overflow-hidden reveal" style={{ transitionDelay: '100ms' }}>
                <div className="bg-white/5 px-4 md:px-6 py-4 flex items-center gap-3 border-b border-white/10">
                    ...
                    <div>
                        ...
                        <div className="hidden md:block overflow-x-auto">
                            <table className="w-full text-sm text-slate-300">
                                <thead className="bg-white/5 text-white font-bold border-y border-white/10">
                                    <tr>
                    ...
                    <div>
                        ...
                        <div className="block md:hidden">
                            ...
                            <div className="bg-black/20 p-4 rounded-xl flex justify-between items-center mt-2 border border-white/5">
                             ...
                             <div className="bg-sky-500 p-4 rounded-xl flex justify-between items-center mt-4 shadow-lg shadow-sky-500/20">
                                <span className="font-bold text-white text-sm">TOTAL SEMINAR</span>
                                <span className="font-bold text-white text-lg">Rp2.450.000</span>
                            </div>
                        </div>
                        ...
                        <div className="hidden md:block overflow-x-auto">
                            <table className="w-full text-sm text-slate-300">
                                ...
                                <tbody className="divide-y divide-white/5">
                                    ...
                                    <tr className="bg-sky-600/20 text-sky-300 font-bold text-base border-t border-sky-500/50">
            ...
            <div className="bg-navy-900/50 backdrop-blur-md rounded-2xl shadow-xl border border-white/10 overflow-hidden reveal" style={{ transitionDelay: '200ms' }}>
                <div className="bg-white/5 px-4 md:px-6 py-4 flex items-center gap-3 border-b border-white/10">
                    <div className="p-2 bg-white/10 rounded-lg">
                    ...
                    <div className="block md:hidden">
                        {[
                         ...
                         <div className="bg-sky-500 p-4 rounded-xl flex justify-between items-center mt-4 shadow-lg shadow-sky-500/20">
                            ...
                            <span className="font-bold text-white text-lg">Rp13.990.000</span>
                        </div>
                    </div>
            ...
            <div className="bg-navy-900/50 backdrop-blur-md rounded-2xl shadow-xl border border-white/10 overflow-hidden reveal" style={{ transitionDelay: '300ms' }}>
                <div className="bg-white/5 px-4 md:px-6 py-4 flex items-center gap-3 border-b border-white/10">
                    <div className="p-2 bg-white/10 rounded-lg">
                    ...
                    <div className="block md:hidden">
                        {[
                         ...
                         <div className="bg-sky-500 p-4 rounded-xl flex justify-between items-center mt-4 shadow-lg shadow-sky-500/20">
                            ...
                            <span className="font-bold text-white text-lg">Rp1.250.000</span>
                        </div>
                    </div>
            ...
            <div className="bg-navy-900/50 backdrop-blur-md rounded-2xl shadow-xl border border-white/10 overflow-hidden reveal" style={{ transitionDelay: '400ms' }}>
                <div className="bg-white/5 px-4 md:px-6 py-4 flex items-center gap-3 border-b border-white/10">
                    <div className="p-2 bg-white/10 rounded-lg">
                ...
                <div className="p-4 md:p-6">
                    ...
                    <div className="block md:hidden">
                        ...
                        <div className="bg-sky-500 p-4 rounded-xl flex justify-between items-center mt-4 shadow-lg shadow-sky-500/20">
                            ...
                            <span className="font-bold text-white text-lg">Rp4.702.000</span>
                        </div>
                    </div>
            ...
            {/* TOTAL REKAPITULASI */}
            <div className="bg-gradient-to-br from-navy-900 to-sky-900/50 text-white rounded-3xl shadow-2xl overflow-hidden border border-white/20 relative reveal delay-500">
                 ...
                 <div className="p-6 md:p-12 text-center relative z-10">
                    ...
                    <div className="hidden md:block max-w-3xl mx-auto bg-white/10 backdrop-blur-md rounded-xl overflow-hidden border border-white/20 mb-8 hover:bg-white/15 transition-colors">
                        <table className="w-full text-left">
                            <thead className="bg-black/20 text-amber-400 font-bold uppercase text-sm tracking-wider">
                                <tr>
                            ...
                            <tbody className="divide-y divide-white/10 text-lg">
                                {[
                                    ...
                                    <tr key={idx} className="hover:bg-white/5 transition-colors">
                                        ...
                                        <td className="px-6 py-4 text-right font-mono font-bold text-sky-200">{row.total}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
                    ...
                    <div className="bg-amber-500 text-navy-950 rounded-xl p-6 md:p-8 flex flex-col md:flex-row justify-between items-center gap-4 shadow-lg shadow-amber-500/20 mx-auto max-w-3xl hover:scale-105 transition-transform duration-300">
