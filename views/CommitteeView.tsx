...
const CommitteeView: React.FC = () => {
  ...
  return (
    <div className="pt-24 pb-20 bg-navy-950 min-h-screen overflow-hidden relative">
      {/* Background Image Setup - 4 Layers for long page */}
      <div className="absolute inset-0 z-0 opacity-40">
        <div className="w-full h-full relative">
            ...
            <img src="https://i.ibb.co.com/M42sjzx/Gemini-Generated-Image-g3n9ing3n9ing3n9-1.png" className="w-full h-screen object-cover object-center absolute top-[300vh] left-0" />
        </div>
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="text-center mb-10 md:mb-12 reveal">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/10 text-white rounded-full text-xs font-bold uppercase tracking-widest mb-4 border border-white/20 backdrop-blur-md">
                <Sparkles size={14} className="text-amber-400" /> Dies Natalis VI
            </div>
            <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold text-white mb-2 md:mb-4 uppercase leading-tight drop-shadow-xl">
                Struktur Kepengurusan <br className="hidden md:block" /> Dies Natalis KMH LOTIM FH UNRAM Ke-6
            </h2>
            <p className="text-sm md:text-base text-slate-300 max-w-2xl mx-auto mt-4">
        ...
        {penanggungJawab && (
            <div className="flex justify-center mb-12 md:mb-16 reveal delay-100">
                <div className="group relative w-full max-w-3xl bg-white/5 backdrop-blur-lg rounded-3xl p-6 md:p-10 shadow-2xl hover:shadow-[0_20px_50px_rgba(56,189,248,0.15)] transition-all duration-700 overflow-visible border border-white/10">
                     {/* Background Glow */}
                     ...
                     <div className="flex flex-col md:flex-row items-center gap-6 md:gap-12 relative z-10">
                        ...
                        <div className="relative flex-shrink-0 animate-float">
                            <div className="w-32 h-32 md:w-56 md:h-56 rounded-full p-1.5 bg-gradient-to-br from-white via-sky-400 to-navy-900 shadow-2xl">
                                <div className="w-full h-full rounded-full overflow-hidden bg-navy-950 border-4 border-navy-900 relative group-hover:rotate-3 transition-transform duration-500">
                            ...
                            <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-sky-500 text-white px-4 py-1.5 rounded-full text-xs font-bold shadow-lg whitespace-nowrap border-2 border-navy-900">
                                Penanggung Jawab
                            </div>
                        </div>
                        ...
                        <div className="text-center md:text-left">
                            <Quote className="text-white/20 mb-4 mx-auto md:mx-0 transform -scale-x-100 w-8 h-8 md:w-12 md:h-12 animate-pulse-slow" />
                            <h3 className="text-2xl md:text-4xl font-bold text-white mb-2">{penanggungJawab.name}</h3>
                            <div className="h-1.5 w-16 bg-gradient-to-r from-sky-500 to-white mx-auto md:mx-0 mb-4 rounded-full"></div>
                            <p className="text-slate-300 leading-relaxed italic text-sm md:text-lg font-serif">
        ...
        <div className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-6xl mx-auto px-4 md:px-0">
                {coreCommittee.map((member, idx) => (
                    <div 
                        key={member.id} 
                        className="group relative h-[350px] md:h-[420px] rounded-2xl overflow-hidden shadow-lg md:shadow-xl cursor-pointer reveal border border-white/10"
                    ...
                    >
                        ...
                        {/* Overlay Gradient */}
                        <div className="absolute inset-0 bg-gradient-to-t from-navy-950 via-navy-950/40 to-transparent opacity-80 group-hover:opacity-90 transition-opacity duration-500"></div>
        ...
        <div className="max-w-7xl mx-auto reveal delay-200">
                    ...
                    <button
                        ...
                        className={`px-4 py-2 rounded-full text-xs md:text-sm font-bold transition-all duration-300 border relative overflow-hidden ${
                            activeDivision === div.key 
                                ? 'bg-sky-500 text-white border-sky-500 shadow-lg transform scale-110 z-10' 
                                : 'bg-white/5 text-slate-300 border-white/10 hover:border-sky-400 hover:text-white'
                        }`}
                    >
                        {div.key}
                    </button>
            ...
            <div className="bg-navy-900/50 backdrop-blur-md rounded-3xl shadow-2xl overflow-hidden border border-white/10 flex flex-col md:flex-row transition-all duration-500 min-h-[500px]" key={activeDivision}>
                ...
                <div className="w-full md:w-[55%] p-6 md:p-10 flex flex-col justify-center relative animate-slideInRight">
                    ...
                    <div className="mb-8">
                        <p className="text-sm md:text-lg text-slate-300 leading-relaxed italic font-serif border-l-4 border-sky-400 pl-4 py-2 bg-white/5 rounded-r-lg">
                    ...
                    {/* Coordinator Section */}
                    {activeCoordinator && (
                        <div className="mb-8 bg-black/20 p-4 rounded-xl border border-white/10 shadow-md flex items-center justify-between hover:border-white/30 transition-colors">
                            <div className="flex items-center gap-4">
                                <div className="h-12 w-12 bg-sky-500 rounded-full flex items-center justify-center text-white shadow-lg">
                                    <Star size={20} fill="currentColor" className="animate-spin-slow" />
                                </div>
                                <div>
                                    <span className="text-xs font-bold text-amber-400 uppercase tracking-widest mb-0.5 block">Koordinator Divisi</span>
                    ...
                    <div className="bg-black/20 p-6 rounded-2xl border border-white/5">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            {activeStaff.map((staff, idx) => (
                                <div key={staff.id} 
                                    className="flex items-center p-2 rounded-lg hover:bg-white/5 hover:shadow-sm transition-all border border-transparent hover:border-white/10 group/item"
                                    style={{ animationDelay: `${idx * 50}ms` }}
                                >
                                    <div className="w-2 h-2 rounded-full bg-slate-500 mr-3 group-hover/item:bg-sky-400 transition-colors flex-shrink-0 group-hover/item:scale-125"></div>
