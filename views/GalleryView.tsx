...
const GalleryView: React.FC = () => {
  ...
  return (
    <div className="pt-24 pb-20 bg-navy-950 min-h-screen relative">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        {/* Gallery Grid - Animated Entrance */}
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6" key={activeTab}>
          {filteredItems.map((item, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-navy-900/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center backdrop-blur-[2px]">
                 {item.type === 'video' ? (
                     <PlayCircle className="text-white transform scale-50 group-hover:scale-100 transition-transform duration-500" size={56} />
                 ) : (
        ...
        >
            ...
            <div className="max-w-6xl max-h-[90vh] w-full flex flex-col items-center justify-center relative animate-zoom-in" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="mt-6 text-center px-4 max-w-2xl">
                    <h3 className="text-white font-bold text-xl">{filteredItems[selectedImageIndex].caption}</h3>
